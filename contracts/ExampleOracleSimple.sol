...
contract ExampleOracleSimple {
    ...
    // modified function interface to be able to parse generic initCodeHash
    constructor(address factory, address tokenA, address tokenB, bytes _initCodeHash) public {
        IUniswapV2Pair _pair = IUniswapV2Pair(UniswapV2Library.pairFor(factory, tokenA, tokenB, _initCodeHash));
        pair = _pair;
        token0 = _pair.token0();
        token1 = _pair.token1();
